# Rails WP Headless CMS

A production-ready headless CMS built with Ruby on Rails 8, strictly adhering to the WordPress database schema. This system provides robust REST and GraphQL APIs, JWT authentication, and modern Rails features while maintaining compatibility with legacy WordPress data.
