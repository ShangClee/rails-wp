...
*   **Root**: `frontWP/adminWP/`
*   **Entry Point**: `frontWP/adminWP/index.html` (The Admin Shell)
*   **Setup Page**: `frontWP/adminWP/setup.html` (Standalone, separate from the main shell)
*   **Login Page**: `frontWP/adminWP/login.html` (Entry point for authentication)
...
### 3. Routing
*   **Web**: Nginx serves `frontWP/adminWP/` for all admin routes.
*   **API**:
...
1.  **Directory Restructuring**:
    *   Ensure `frontWP/adminWP` exists.
    *   Create `frontWP/adminWP/cms/` and `frontWP/adminWP/system/` directories.
...
## Todo List
- [x] Create folder structure `frontWP/adminWP/{cms,system}`
- [x] Create `frontWP/adminWP/index.html` with tabbed layout
- [x] Implement basic auth check in `index.html`
- [x] Add "CMS" dashboard placeholder
- [x] Add "System" dashboard placeholder
- [x] Create `frontWP/adminWP/cms/posts.html` (List Posts)
- [x] Create `frontWP/adminWP/system/users.html` (List Users)
